from input_functions import take_input_images_and_assign_label
import cv2
import os
import numpy as np
from input_functions import face_lock
import timeit
from timeit import default_timer as timer
font = cv2.FONT_HERSHEY_SIMPLEX
cascPath = "haarcascade_frontalface_default.xml"
faceCascade = cv2.CascadeClassifier(cascPath)
subjects = ["","avyact","anu","mohit"]
 
# number_of_people = int(input('Enter the number of people you want to train the model for ---->    '))
# loop_counter = 1
#      
#      
# while (number_of_people > 0):
#      name = input("Enter your Name ----->   ")
#      number_of_images = int(input('How many images do you want to capture? ( 10 Recommended ) ------> '))
#      subjects.append(name)
#      take_input_images_and_assign_label('s' + str(loop_counter), number_of_images)
...
def detect_face(img):
    ...
    cascPath = "/Users/avyactjain/workspace/Facial Recognition/haarcascade_frontalface_default.xml"
    ...
    while True:
        # Capture frame-by-frame
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.putText(frame,'Press L to Lock on Face',(10,500), font, 1,(0,255,0),2,cv2.LINE_AA)
...
#                 break
            if cv2.waitKey(1) & 0xFF == ord('l'):
               ...
               cv2.imwrite(os.path.join(working_path+str(counter)+'.png'), resized_image)
...
faces, labels = prepare_training_data("/Users/avyactjain/workspace/Facial Recognition/training_data")
print("Data prepared")
...
#     draw_text(img, label_text, rect[0], rect[1]-5)
    print('You Look Like...... ',label_text)
    end_time = timer()
...
#load test images
# test_img1 = cv2.imread("/Users/avyactjain/workspace/Facial Recognition/testing_data/3.png")
